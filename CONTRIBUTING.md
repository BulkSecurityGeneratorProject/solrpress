# Contributing to SolrPress

SolrPress is a large community project with many different developers contributing at all levels to the project. We're **actively** looking for more contributors right now.  (Jan 2014)

## Casual Involvement
* Improve the SolrPress.io site ([tickets](https://github.com/dynamicguy/SolrPress.github.io/issues))
* Move forward [SolrPress.io redesign](https://github.com/dynamicguy/SolrPress.github.io/issues/7)
* Attend team meetings
* Comment on issues and drive to resolution

## High-impact Involvement

* Maintaining the SolrPress client. 
  * [Authoring client tests](https://github.com/dynamicguy/SolrPress/SolrPress/issues/801)
  * Read [Architecture doc](https://github.com/dynamicguy/SolrPress/SolrPress/wiki/Rewrite-architecture)
  * Triage, close, fix and resolve [issues](https://github.com/dynamicguy/SolrPress/SolrPress/issues)
* Developing the [new registry server](https://github.com/dynamicguy/SolrPress/registry/tree/node_rewrite)
  * Hooking in to Elastic Search rather than the in-memory search
  * Getting SolrPress/registry-client to talk to the new server without breaking backwards compatibility
...
* Please **do not** use the issue tracker for personal support requests. Use
  [Stack Overflow](http://stackoverflow.com/questions/tagged/SolrPress), our
  [Mailing List](http://groups.google.com/group/twitter-SolrPress)
  (twitter-SolrPress@googlegroups.com), or
  [#SolrPress](http://webchat.freenode.net/?channels=SolrPress) on Freenode.
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/SolrPress
   # Navigate to the newly cloned directory
   cd SolrPress
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/dynamicguy/SolrPress/SolrPress
   ```
