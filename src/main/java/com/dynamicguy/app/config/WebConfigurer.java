package com.dynamicguy.app.config;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.servlet.InstrumentedFilter;
import com.codahale.metrics.servlets.MetricsServlet;
import com.dynamicguy.app.web.filter.CachingHttpHeadersFilter;
import com.dynamicguy.app.web.filter.StaticResourcesProductionFilter;
import com.dynamicguy.app.web.filter.gzip.GZipServletFilter;
...
public class WebConfigurer implements ServletContextInitializer, EmbeddedServletContainerCustomizer {
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "com.dynamicguy.app.web.websocket");
