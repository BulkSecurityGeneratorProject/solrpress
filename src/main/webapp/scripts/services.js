...
solrpressApp.factory("MetricsService", function($http) {
  return {
    get: function() {
      var promise;
      promise = $http.get("metrics/metrics").then(function(response) {
...
solrpressApp.factory("ThreadDumpService", function($http) {
  return {
    dump: function() {
      var promise;
      promise = $http.get("dump").then(function(response) {
        return response.data;
      });
      return promise;
    }
...
solrpressApp.factory("HealthCheckService", function($rootScope, $http) {
  return {
    check: function() {
      var promise;
      promise = $http.get("health").then(function(response) {
        return response.data;
      });
      return promise;
    }
...
solrpressApp.factory("ConfigurationService", function($rootScope, $filter, $http) {
  return {
    get: function() {
      var promise;
      promise = $http.get("configprops").then(function(response) {
...
solrpressApp.factory("AuditsService", function($http) {
  return {
    findAll: function() {
      var promise;
      promise = $http.get("app/rest/audits/all").then(function(response) {
        return response.data;
      });
      return promise;
    },
