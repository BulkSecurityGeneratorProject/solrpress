...
var solrpressApp = angular.module('solrpressApp', ['http-auth-interceptor', 'tmh.dynamicLocale', 'ngResource', 'ngRoute', 'ngCookies', 'solrpressAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);

solrpressApp.config(function ($routeProvider, $httpProvider, $locationProvider, $translateProvider, tmhDynamicLocaleProvider, httpRequestInterceptorCacheBusterProvider, USER_ROLES) {
