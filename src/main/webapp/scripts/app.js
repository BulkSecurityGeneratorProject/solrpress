...
var solrPressApp = angular.module('solrPressApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'solrPressAppUtils', 'pascalprecht.translate', 'truncate']);
