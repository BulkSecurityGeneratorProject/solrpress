...
(function() {
  'use strict';
  angular.module('solrpressApp', ['LocalStorageModule', 'tmh.dynamicLocale', 'ngResource', 'ui.router', 'ngCookies', 'pascalprecht.translate', 'ngCacheBuster', 'ui.bootstrap']).run(function($rootScope, $location, $http, $state, $translate, Auth, Principal, Language) {
